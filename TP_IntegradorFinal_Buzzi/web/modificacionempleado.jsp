                        ...
                        <div class="col-md-6">
                            <div class="card shadow-lg">
                                <div class="card-header">
                                    <h7>Actualización de datos de empleados</h7>
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="SV_Modificar_Empleado" method="Get">

                                        <label for="nombre">Nombre</label><input type="text" name="nombre" value="<%=emp.getNombre()%>" maxlength="30" class="form-control" required>
                                        <label for="apellido">Apellido</label><input type="text" name="apellido" maxlength="30" value="<%=emp.getApellido()%>" class="form-control" required> 
                                        ...
                                        <label for="nacionalidad">Nacionalidad</label><input type="text" name="nacionalidad" value="<%=emp.getNacionalidad()%>" maxlength="15" class="form-control" required> 
                                        <label for="celular">Teléfono Celular</label><input type="tel" name="celular" class="form-control" value="<%=emp.getCelular()%>" maxlength="18" required> 
                                        ...
                                        <label for="cargo">Cargo</label><input type="text" name="cargo" maxlength="15" value="<%=emp.getCargo()%>" class="form-control" required>  
                                        <label for="sueldo">Sueldo</label><input type="number" name="sueldo" placeholder="0.00" value="<%=emp.getSueldo()%>" min="0" max="99999999999999" step="0.05" maxlength="15" class="form-control" required> 
                                        <label for="nombreUsuario">Nombre de Usuario</label><input type="text" name="nombreUsuario" value="<%=emp.getUnUsuario().getNombre_usuario()%>" class="form-control"  maxlength="20" required> 
                                        <label for="contrasenia">Contraseña</label><input type="password" name="contrasenia" maxlength="25" value="<%=emp.getUnUsuario().getContraseña()%>" class="form-control" required> 
                                        <input type="hidden" name="id" value="<%=emp.getCodigo_empleado()%>" required>
                                        <p></p>

                ...
                <div class="col-md-12">
                    ...
                    <div class="card shadow-lg">
                        <div class="card-header">
                            <h7>Listados de paquetes turísticos</h7>
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr  class="text-center">
                                                    <td class="text-center"><%= paq.getCodigo_paquete()%></td>

                                                    <%long id = paq.getCodigo_paquete();%>

                                                    <td  class="text-center"><%= paq.getCosto_paquete()%></td>



                                                    <td  class="text-left">
                                                        <form name="borrarPaquete" action="SV_Eliminar_Paquete" method="post"> 
                                                    ...
                                                    <td class="text-left">
                                                        <form name="modificarPaquete" action="SV_Modificar_Paquete" method="post"> 
                                                            <input type="hidden" name="id"  value="<%=id%>">

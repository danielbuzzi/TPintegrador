 ...
 * @author daniel
 */
@WebServlet(name = "SV_Eliminar_Empleado", urlPatterns = {"/SV_Eliminar_Empleado"})
public class SV_Eliminar_Empleado extends HttpServlet {

 ...
 * @author daniel
 */
@WebServlet(name = "SV_Alta_Paquete", urlPatterns = {"/SV_Alta_Paquete"})
public class SV_Alta_Paquete extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        controlserv.crearPaquete(total, costo, idsa, destino, descripcionbreve, nombre, fecha);

                ...
                <div class="col-md-12">
                    ...
                    <div class="card shadow-lg">
                        <div class="card-header">
                            <h7>Alta de Paquetes turísticos</h7>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <form action="SV_Alta_Paquete" onsubmit=" return grillaVacia()" method="post">
                                       ...
                                       <th>Cod.</th>
                                        ...
                                        <p></p>
                                        Total $:<input type="text" name="total" value="0" id="costopaquete" readonly>

                   ...
                   <header>
                    ...
                    <div class="card shadow-lg">
                        <div class="card-header">
                            <h7>Listados de servicios turísticos</h7>
                                            ...
                                            <tbody>
                                                    ...
                                                    for (ServicioTuristico serv : listaServicios) {
                                                     if (serv.isHabilitado()) {  
                                                       ...
                                                       String fechaserv=formato.format(serv.getFecha_servicio());
                                                %>
                                                <tr  class="text-center">
                                                    <td class="text-center"><%= fechaserv%></td>
                                                    <td  class="text-center"><%= serv.getNombre() %></td>
                                                    <td  class="text-center"><%= serv.getDescripcion_breve() %></td>
                                                    <td  class="text-center"><%= serv.getDestino_servicio() %></td>
                                                    <td  class="text-center"><%= serv.getCosto_servicio() %></td>
                                                
                                                    <%long id = serv.getCodigo_servicio();%>

                                                    <td  class="text-left">
                                                        <form name="borrarServicio" action="SV_Eliminar_Servicio" method="post"> 
                                                    ...
                                                    <td class="text-left">
                                                        <form name="modificarServicio" action="SV_Modificar_Servicio" method="post"> 
                                                            <input type="hidden" name="id"  value="<%=id%>">

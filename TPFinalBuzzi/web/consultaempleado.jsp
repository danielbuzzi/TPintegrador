                                        ...
                                        <table class="table table-striped ">
                                            ...
                                            <tbody>
                                                ...
                                                <tr  class="text-center">
                                                    ...
                                                    <td  class="text-center"><%= cli.getCargo()%></td> 
                                                    <td class="text-center"><%= cli.getUnUsuario().getNombre_usuario()%></td>
                                                    <%long id = cli.getCodigo_empleado();%>

                                                    <td  class="text-left">
                                                        <form name="borrarEmpleado" action="SV_Eliminar_Empleado" method="post"> 
                                                    ...
                                                    <td class="text-left">
                                                        <form name="modificarEmpleado" action="SV_Modificar_Empleado" method="post"> 
                                                            <input type="hidden" name="id"  value="<%=id%>">

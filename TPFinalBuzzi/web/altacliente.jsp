                    ...
                    <header>
                        <div id="cabecera">
                            <div align="right">  
                                ...
                                <%
                                    usu = (String) request.getSession().getAttribute("usuario");
                                    if (usu != null) {%>
                                    <h7>Bienvenido:</h7>
                        ...
                        <div class="col-md-6">
                            <div class="card shadow-lg">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="Sv_Alta_Cliente" method="POST">

                                        <label for="nombre">Nombre</label><input type="text" name="nombre" maxlength="35" class="form-control" required>
                                        <label for="apellido">Apellido</label><input type="text" name="apellido" maxlength="35" class="form-control" required> 
                                        ...
                                        <label for="nacionalidad">Nacionalidad</label><input type="text" name="nacionalidad" maxlength="17" class="form-control" required> 
                                        <label for="celular">Teléfono Celular</label><input type="tel" name="celular"  maxlength="13" class="form-control"  required> 

 ...
 * @author daniel
 */
@WebServlet(name = "Sv_Alta_Venta", urlPatterns = {"/Sv_Alta_Venta"})
public class Sv_Alta_Venta extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        controlven.crearVenta(mediopago, fechaservicio, paquete, servicio, empleado, cliente);
